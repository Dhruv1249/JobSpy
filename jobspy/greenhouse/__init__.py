...
class Greenhouse(Scraper):
    ...
    def __init__(self, proxies: list[str] | str | None = None, ca_cert: str | None = None, user_agent: str | None = None):
        ...
        """
        super().__init__(Site.GREENHOUSE, proxies=proxies, ca_cert=ca_cert, user_agent=user_agent)
    ...
    def scrape(self, scraper_input: ScraperInput) -> JobResponse:
        ...
        for job_data in data.get("jobs", []):
            ...
            location_name = job_data.get("location", {}).get("name", "Remote")
